...
Mexico has an synchronic invoicing system, which means that documents will be checked immediately as you
issue them.
...
Mexico allows you to directly cancel documents without the need for a credit note in certain cases.
You will see document_status change to value 2. All other fields will remain the same.